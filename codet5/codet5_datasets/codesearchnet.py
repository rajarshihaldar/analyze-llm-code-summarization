...
from codet5_datasets.transform_dataset import modify_func_names, obscure, remove_comments_from_code, extract_comments_from_code
...
class CodeSearchNet(BaseDataset):
    ...
    def _load(self):
        ...
        for i in trange(self.num_files[self.dataset]):
            fname = 'python_{}_{}.jsonl'.format(self.dataset, i)
            func_names = []
            with open(os.path.join(self.root, self.dataset, fname)) as f:
